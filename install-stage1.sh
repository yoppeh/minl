...
PASS=1 binutils_v='2.27' ./1-binutils.sh
PASS=1 gcc_v='6.3.0' mpfr_v='3.1.5' gmp_v='6.1.2' mpc_v='1.0.3' ./1-gcc.sh
linux_v='4.9.2' ./1-linux-headers.sh
glibc_v='2.24' ./1-glibc.sh
